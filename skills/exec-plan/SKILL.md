...
`<CODEOPS_PYTHON>` for every shipped Python command. Each direct state, roadmap, migration, or
worktree command still reruns its own authoritative registered gate.
