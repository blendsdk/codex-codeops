...
- RD-022: deterministic Python 3.x and Windows prerequisite enforcement before mutation.
...
- UNC and network workspaces remain outside the certified boundary under governing AR-018.
...
2. [ ] GitHub issue #2 is closed by native owner-identity and recovery behavior that preserves
   existing Linux semantics.
3. [ ] Native Windows CI and retained Windows 11 CLI/desktop evidence satisfy RD-023.
4. [ ] Ubuntu behavior and every confirmed repository verification check remain green.
