...
argument arrays, closed option parsing, canonical paths, and explicit working directories. Git
...
recoverable failure. It rejects unsupported filesystems through 03-01 and uses 03-03 path/write
primitives (AR-8, AR-11).
...
tests. Writes use 03-03 atomic primitives (AR-2, AR-10).
...
rules. `--launch` starts native `codex` on Windows and never delegates through a shell, Git Bash,
or WSL (AR-4, AR-11).
...
- Specification tests cover ST-21–ST-27 and ST-31–ST-36.
