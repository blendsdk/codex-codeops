...
| requirement/specification/criterion | `draft`, `approved`, `superseded` |
| test | `planned`, `red-confirmed`, `passing`, `blocked` |
| task | `pending`, `implemented`, `verified`, `blocked` |
| implementation | `present`, `superseded`, `reverted` |
